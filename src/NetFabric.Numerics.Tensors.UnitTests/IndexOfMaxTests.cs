...
public class IndexOfMaxTests
{
    ...
    public static void IndexOfMax_With_NaN_Should_Return_NaN(float[] source)
    {
        // arrange
        var expected = TensorPrimitives.IndexOfMax(source);

        // act
        var result = TensorOperations.IndexOfMax<float>(source);
